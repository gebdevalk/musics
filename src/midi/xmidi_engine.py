...
#
#     return MidiNote(channel=channel, duration=leaf.duration, pitches=leaf.pitches, velocity=velocity,
#                     articulation=leaf.articulation, program=timbre, cc_values={CC_PANNING: panning_cc})
